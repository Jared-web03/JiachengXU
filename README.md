...
- `style.css`：浅灰白背景、白色正文与浅灰蓝侧栏、侧栏与响应式布局；包含对应深色模式。
...
学术信息依据本人提供的简历，论文图与相关方法描述依据本人提供的五张图片。清华大学硕士专业为大模型科学与工程。硕士入学年份按 2026 年 9 月提供的“明年入学”信息写为 2027。未公开电话或原始简历文件；凭据不保存在项目中。
